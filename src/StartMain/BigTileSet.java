 ...
 * @author kevin
 */
public class BigTileSet {
	/** The map this tileset was loaded as part of */
	private final BigTiledMap map;
	 ...
	 */
	public BigTileSet(BigTiledMap map, Element element, boolean loadImage)
			throws SlickException {
		this.map = map;
		...
		if (loadImage) {
			BigImage image = new BigImage(map.getTilesLocation() + "/" + ref, Image.FILTER_NEAREST);
	 ...
	 */
	public void setTileSetImage(BigImage image) {
